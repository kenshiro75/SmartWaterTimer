...
const char PROGMEM ESP8266HTTPUpdateServer::_serverIndex[] = R"(
<!DOCTYPE html>
<html>
  <head>
  <meta name = "viewport" content = "width = device-width, initial-scale = 1.0, maximum-scale = 1.0, user-scalable=0">
  <title>RFM69 Updater</title>
  </head>
  <body>
...
const char PROGMEM ESP8266HTTPUpdateServer::_failedResponse[] = R"(
<!DOCTYPE html>
<html>
  <head>
    <meta name = "viewport" content = "width = device-width, initial-scale = 1.0, maximum-scale = 1.0, user-scalable=0">
...
const char PROGMEM ESP8266HTTPUpdateServer::_successResponse[] = R"(
<!DOCTYPE html>
<html>
  <head>
    <meta name = "viewport" content = "width = device-width, initial-scale = 1.0, maximum-scale = 1.0, user-scalable=0">
  ...
  <body>
    <h3>Update Success! Rebooting...<h3>
  </body>
</html>
)";
...
void ESP8266HTTPUpdateServer::setup(ESP8266WebServer *server, const char * path, const char * username, const char * password)
{
    ...
    _server->on(path, HTTP_GET, [&](){
      ...
      _server->send_P(200, "text/html", _serverIndex);
    });
